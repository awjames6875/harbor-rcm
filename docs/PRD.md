...
2. **Room 2 — `2_verification/`:** Looks up payer, retrieves credentials from AWS Secrets Manager, drives Skyvern through the right portal workflow (or hits Availity API directly), captures raw 271 response.
